...
save_to="/scratch/cp3759/pyqg_data/sims/KE_accumulation/offline_only_test"
...
do
   eval sbatch submit_array_cpu.sh --save_to $save_to --model_string $model_string --alpha $alpha
done
